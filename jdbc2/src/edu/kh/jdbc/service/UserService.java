...
public class UserService {
	...
	public List<User> selectUser(int input) throws Exception{
		Connection conn = getConnection();
		List<User> userList = dao.selectUser(conn, input);
	...
	public int updateName(String originName, String newName) throws Exception {
		Connection conn = getConnection();

		int result = dao.updateName(conn, originName, newName);
